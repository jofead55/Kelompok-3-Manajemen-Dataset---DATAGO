...
class DatasetViewSet(viewsets.ModelViewSet):
    ...
    def stats(self, request, pk=None):
        ...
        return Response({'error': 'Tidak CSV file found.'}, status=status.HTTP_404_NOT_FOUND)
...
class DatasetRequestViewSet(viewsets.ModelViewSet):
    ...
    def match(self, request, pk=None):
        ...
        if req.status in ['COMPLETED', 'REJECTED']:
            return Response({"error": "Cari tidak tersedia untuk request yang sudah selesai."}, status=400)
...
class DashboardStatsView(APIView):
    ...
    def get(self, request):
        ...
        return Response({
            ...
            'unduhan_per_year': total_unduhan_per_year,
        })
